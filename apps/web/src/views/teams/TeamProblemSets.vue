<template>
  <section class="workspace-view">
    ...
    <el-dialog v-model="createVisible" title="创建团队题单" width="520px">
...
@media (max-width: 680px) { .workspace-view { padding: 22px 14px 44px; } .view-heading { align-items: stretch; flex-direction: column; } .problem-set-card { grid-template-columns: 42px minmax(0, 1fr); } .problem-set-card .el-button { grid-column: 1 / -1; } }
</style>
