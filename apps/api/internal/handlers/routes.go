...
func (s Server) registerAPIRoutes(api *gin.RouterGroup) {
	...
	auth.PUT("/teams/:id/contests/:contest_id", s.updateTeamContest)
	auth.DELETE("/teams/:id/contests/:contest_id", s.deleteTeamContest)
	auth.POST("/teams/:id/contests/:contest_id/publish", s.publishTeamContest)
	...
	auth.GET("/contests/:contest_id", s.getTeamContest)
	auth.PUT("/contests/:contest_id", s.updateTeamContest)
	auth.DELETE("/contests/:contest_id", s.deleteTeamContest)
	auth.POST("/contests/:contest_id/publish", s.publishTeamContest)
	auth.POST("/contests/:contest_id/problems", s.addTeamContestProblem)
	auth.DELETE("/contests/:contest_id/problems/:problem_id", s.removeTeamContestProblem)
	auth.GET("/contests/:contest_id/submissions", s.listTeamContestSubmissions)
	auth.POST("/contests/:contest_id/submissions", s.createTeamContestSubmission)
	auth.GET("/contests/:contest_id/ranking", s.teamContestRanking)
	...
	auth.PUT("/teams/:id/problem-sets/:set_id", s.updateTeamProblemSet)
	auth.DELETE("/teams/:id/problem-sets/:set_id", s.deleteTeamProblemSet)
	...
	auth.GET("/problem-sets/:set_id", s.getTeamProblemSet)
	auth.PUT("/problem-sets/:set_id", s.updateTeamProblemSet)
	auth.DELETE("/problem-sets/:set_id", s.deleteTeamProblemSet)
	auth.POST("/problem-sets/:set_id/problems", s.addTeamProblemSetProblem)
	auth.DELETE("/problem-sets/:set_id/problems/:problem_id", s.removeTeamProblemSetProblem)
	auth.GET("/problem-sets/:set_id/submissions", s.listTeamProblemSetSubmissions)
	auth.POST("/problem-sets/:set_id/submissions", s.createTeamProblemSetSubmission)
	auth.GET("/problem-sets/:set_id/discussions", s.listTeamDiscussions)
	auth.POST("/problem-sets/:set_id/discussions", s.createTeamDiscussion)
	...
	auth.GET("/submissions/latest", s.latestSubmissions)
