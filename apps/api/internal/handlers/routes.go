...
func (s Server) registerAPIRoutes(api *gin.RouterGroup) {
	...
	api.GET("/problems/catalog", middleware.OptionalAuth(s.DB, s.Cfg.JWTSecret), s.listProblemCatalog)
	...
	auth.POST("/problems", middleware.RateLimitUser(s.Redis, "problems:create", 20, time.Hour), problemChangeTicketOnly)
	auth.PUT("/problem-test-uploads/:upload_id/:chunk_index", problemChangeTicketOnly)
	...
	auth.POST("/problems/upload", middleware.RateLimitUser(s.Redis, "problems:upload", 20, time.Hour), problemChangeTicketOnly)
	auth.PUT("/problems/:id", problemChangeTicketOnly)
	...
	auth.DELETE("/problems/:id", problemChangeTicketOnly)
	auth.GET("/prepared-problems", middleware.RequireRoles(models.RoleAdmin, models.RoleTeacher), s.listPreparedProblems)
	auth.POST("/prepared-problems", middleware.RequireRoles(models.RoleAdmin, models.RoleTeacher), problemChangeTicketOnly)
	auth.POST("/prepared-problems/upload", middleware.RequireRoles(models.RoleAdmin, models.RoleTeacher), problemChangeTicketOnly)
	auth.GET("/prepared-problems/:id", middleware.RequireRoles(models.RoleAdmin, models.RoleTeacher), s.getPreparedProblem)
	auth.PUT("/prepared-problems/:id", middleware.RequireRoles(models.RoleAdmin, models.RoleTeacher), problemChangeTicketOnly)
	auth.POST("/prepared-problems/:id/publish", middleware.RequireRoles(models.RoleAdmin, models.RoleTeacher), problemChangeTicketOnly)
	auth.POST("/problem-change-tickets", middleware.RateLimitUser(s.Redis, "problem-change-tickets:create", 20, time.Hour), s.createProblemChangeTicket)
	auth.GET("/problem-change-tickets/mine", s.listMyProblemChangeTickets)
	auth.GET("/problem-change-tickets/eligible-problems", s.listProblemChangeTicketEligibleProblems)
	auth.GET("/problem-change-tickets", middleware.RequireRoles(models.RoleAdmin), s.listProblemChangeTickets)
	auth.GET("/problem-change-tickets/:id", s.getProblemChangeTicket)
	auth.GET("/problem-change-tickets/:id/attachment", s.downloadProblemChangeTicketAttachment)
	auth.POST("/problem-change-tickets/:id/cancel", s.cancelProblemChangeTicket)
	auth.POST("/problem-change-tickets/:id/reject", middleware.RequireRoles(models.RoleAdmin), s.rejectProblemChangeTicket)
	auth.POST("/problem-change-tickets/:id/apply", middleware.RequireRoles(models.RoleAdmin), s.applyProblemChangeTicket)
	...
	auth.GET("/permissions", middleware.RequireRoles(models.RoleAdmin), s.listUserPermissionDefinitions)
	...
	auth.PUT("/users/:id/permissions/:permission", middleware.RequireRoles(models.RoleAdmin), s.updateUserPermission)
	...
	auth.PUT("/problem-reviews/:id/review", middleware.RequireRoles(models.RoleAdmin), problemChangeTicketOnly)
	auth.PUT("/problem-reviews/:id/withdraw", middleware.RequireRoles(models.RoleAdmin), problemChangeTicketOnly)
}
